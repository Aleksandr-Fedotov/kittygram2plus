...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware',  # регистрируем CORS
...
# Открываем доступ к API с любого домена внутренним к адресам,
# начинающимся с "/api/".
...
REST_FRAMEWORK = {
    ...
    # Настройки троттлинга (регулирования запросов):
